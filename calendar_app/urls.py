...
urlpatterns = [
    ...
    path('calendar/week/', week_view, {'category_str': None, 'year': None, 'month': None, 'day': None}, name='week-view'),
    path('calendar/week/filter/<str:category_str>/', week_view, {'year': None, 'month': None, 'day': None}, name='filtered-week-view'),
    
    # Paths for navigating to specific weeks, with and without category filtering
    path('calendar/week/<int:year>/<int:month>/<int:day>/', week_view, {'category_str': None}, name='week-view-date'),
    path('calendar/week/filter/<str:category_str>/<int:year>/<int:month>/<int:day>/', week_view, name='filtered-week-view-date'),


    # MonthView
    path('calendar/month/', MonthView.as_view(), {'category_str':None},name='month-view'),
    path('calendar/month/filter/<str:category_str>/', MonthView.as_view(), name='filtered-month-view'),
